...
ERROR = '2025/11/19 08:12:10 [error] 12345#0: *1 upstream timed out (110: Connection timed out) while connecting to upstream, client: 192.0.2.1, server: example.com, request: "GET / HTTP/1.1", upstream: "http://127.0.0.1:8080/", host: "example.com"'
