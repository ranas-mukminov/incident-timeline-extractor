...
def test_build_timeline_sorts_and_sets_bounds():
    events = [
        Event(id="b", timestamp=datetime(2025, 11, 19, 8, 12, 5, tzinfo=timezone.utc), source="nginx"),
        Event(id="a", timestamp=datetime(2025, 11, 19, 8, 12, 1, tzinfo=timezone.utc), source="syslog"),
        Event(id="c", timestamp=datetime(2025, 11, 19, 8, 12, 6, tzinfo=timezone.utc), source="zabbix"),
    ]
